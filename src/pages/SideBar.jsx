...
export default function SideBar(){
    ...
    return(
        <>
        <header className="p-4 flex justify-between items-center bg-indigo-900 text-white md:hidden">
            <h1>SomeCompany</h1>
            <button onClick={toggleMenu} className="text-white focus:outline-none">
                <i className="fa-solid fa-bars"></i>
            </button>
        </header>
        <main className={`md:my-12 md:ml-16 md:min-w-[200px] text-white ${menuOpen ? 'block' : 'hidden'} md:block`}>
